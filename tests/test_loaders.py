"""Tests for the nine library adapters.
...
def test_probes_has_exactly_the_nine_expected_names():
    assert set(PROBES.keys()) == EXPECTED_LOADER_NAMES


def test_available_loaders_with_no_names_probes_all_nine():
...
# All nine loaders, probed once at collection time so availability here drives
